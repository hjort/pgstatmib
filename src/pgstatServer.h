...
#define PGSTATSERVER_SIZE			2
#define PGSTATSERVER_BACKENDS		3
#define PGSTATSERVER_COMMITS		4
#define PGSTATSERVER_ROLLBACKS		5
#define PGSTATSERVER_BLOCKSREAD		6
#define PGSTATSERVER_BLOCKSHIT		7
